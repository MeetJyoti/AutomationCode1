...
namespace AutomationIC.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Tmfeature", "As a turnup portal admin I would like to create, edit Time and materials Records", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 10
 testRunner.Then("The record should be successfully created", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        public void EditExistingTimeAndMaterialRecord(string description, string[] exampleTags)
        {
...
#line hidden
#line 16
 testRunner.Then(string.Format("The record should have the updtaed \'{0}\'", description), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
